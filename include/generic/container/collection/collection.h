...
template < class type,
           class compares = as_compares<type,std::less<>> >
using rb_tree = redblack_tree<type,compares>;
...
#include "collection_base/collection_global.h" // First.
#include "collection_base/collection_algo.h"

// In folder "collection_class"
#include "collection_class/set.h"
#include "collection_class/map.h"

// In folder "collection_data"
#include "collection_data/map_pair/map_pair.h"
#include "collection_data/flat/sorted_vector.h"
#include "collection_data/tree/tree.h"

// In folder "collection_view"
#include "collection_view/collection_keys_view.h"
#include "collection_view/collection_values_view.h"
