    ...
    extends public collection_algo<basic_map<type1,type2,key_less,container>,pair<const type1,type2>>
{
    ...
    public: // Core
        ...
        constexpr  basic_map ( std::from_range_t, std::ranges::input_range auto&& r ) requires requires { std::declval<basic_map>()[get<0>(*r.begin())] = get<1>(*r.begin()); };
