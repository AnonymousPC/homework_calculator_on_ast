...
class array_filter_view<container_type,filter>::iterator
{
    ...
    public: // Core
        ...
        constexpr iterator& operator = ( const iterator& ); // Checks arr must be same in debug mode.
...
class array_filter_view<container_type,filter>::const_iterator
{
    ...
    public: // Core
        ...
        constexpr const_iterator& operator = ( const const_iterator& ); // Checks arr must be same in debug mode.
