...
template < class container_type, unary_pred<typename container_type::iterate_type> filter >
constexpr array_filter_view<container_type,filter>::iterator& array_filter_view<container_type,filter>::iterator::operator = ( const iterator& right )
{
...
template < class container_type, unary_pred<typename container_type::iterate_type> filter >
constexpr array_filter_view<container_type,filter>::const_iterator& array_filter_view<container_type,filter>::const_iterator::operator = ( const const_iterator& right )
{
    if ( self.arr_ptr == right.arr_ptr ) [[likely]]
        pos = right.pos;
