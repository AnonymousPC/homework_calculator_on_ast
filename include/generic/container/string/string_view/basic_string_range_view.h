...
// No template deduction is declared. Class string_view cannot construct from string ( without 2 index ) or any-string-like else.

#include "basic_string_range_view.cpp"
