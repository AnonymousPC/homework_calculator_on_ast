...
template < class char_type >
constexpr basic_string<char_type>::iterator basic_string<char_type>::begin ( )
{
    return size() <= sso ? internal otherwise external;
}

template < class char_type >
constexpr basic_string<char_type>::const_iterator basic_string<char_type>::begin ( ) const
{
    return size() <= sso ? internal otherwise external;
}

template < class char_type >
constexpr basic_string<char_type>::iterator basic_string<char_type>::end ( )
{
    return size() <= sso ? internal + size() otherwise external + size();
}

template < class char_type >
constexpr basic_string<char_type>::const_iterator basic_string<char_type>::end ( ) const
{
    return size() <= sso ? internal + size() otherwise external + size();
}
...
template < class char_type >
constexpr basic_string<char_type>::operator const char_type* ( ) const
{
    return c_str();
}
