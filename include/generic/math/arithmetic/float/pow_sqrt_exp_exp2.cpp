...
constexpr fraction<type> pow ( fraction<type> a, fraction<type> b )
{
    if ( b.den() == 1 ) // b is integer.
        ...
        return fraction<type> ( pow(typename float_to_float_type<fraction<type>>::type(a), typename float_to_float_type<fraction<type>>::type(b)) );
}
...
constexpr fraction<type> sqrt ( fraction<type> a )
{
    ...
    if ( is_sqrtable(a.num()) and is_sqrtable(a.den()) )
        ...
        return fraction<type> ( sqrt(typename float_to_float_type<fraction<type>>::type(a.num()) / typename float_to_float_type<fraction<type>>::type(a.den())) );
}
