    ...
    requires ( matrix.dimension() == 2 ) and ( number_type<matrix_value_type> or complex_type<matrix_value_type> )
{
    ...
    else
    {
        ...
        {
            throw math_error("cannot calculate eigen of matrix: [[from {}]] {}", "eigen", e.what());
        }
    }
}
    ...
    requires ( matrix.dimension() == 2 ) and ( number_type<matrix_value_type> or complex_type<matrix_value_type> )
{
    ...
    else
    {
        ...
        {
            throw math_error("cannot calculate eigen_value of matrix: [[from {}]] {}", "eigen", e.what());
        }
    }
}
    ...
    requires ( matrix.dimension() == 2 ) and ( number_type<matrix_value_type> or complex_type<matrix_value_type> )
{
    ...
    else
    {
        ...
        {
            throw math_error("cannot calculate eigen_vector of matrix: [[from {}]] {}", "eigen", e.what());
        }
    }
}
