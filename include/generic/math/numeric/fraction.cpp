...
template < int_type type >
std::ostream& operator << ( std::ostream& left, const fraction<type>& right )
{
    if ( right.den() == 1 )
...
template < int_type type >
constexpr std::strong_ordering operator <=> ( const fraction<type>& left, const fraction<type>& right )
{
...
template < int_type type >
constexpr fraction<type> operator + ( const fraction<type>& right )
{
    return right;
}
...
template < int_type type >
constexpr fraction<type> operator + ( const fraction<type>& left, const fraction<type>& right )
{
    using double_size_int = aux::double_size_int<type>;
